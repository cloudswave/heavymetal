...
CREATE DATABASE `hm` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `hm`;

DROP TABLE IF EXISTS `hm_action`;
CREATE TABLE `hm_action` (
...
INSERT INTO `hm_action` (`id`, `name`, `title`, `remark`, `rule`, `log`, `type`, `status`, `update_time`) VALUES
...
DROP TABLE IF EXISTS `hm_action_log`;
CREATE TABLE `hm_action_log` (
...
INSERT INTO `hm_action_log` (`id`, `action_id`, `user_id`, `action_ip`, `model`, `record_id`, `remark`, `status`, `create_time`) VALUES
(1,	1,	1,	-1062725418,	'member',	1,	'admin在2014-10-08 19:08登录了后台',	1,	1412766537),
(2,	1,	1,	-1062725418,	'member',	1,	'admin在2014-10-08 19:10登录了后台',	1,	1412766601),
(3,	7,	1,	-1062725418,	'model',	4,	'操作url：/onethink/wwwroot/admin.php?s=/Model/update.html',	1,	1412767812),
(4,	7,	1,	-1062725418,	'model',	4,	'操作url：/onethink/wwwroot/admin.php?s=/Model/update.html',	1,	1412768494),
(5,	7,	1,	-1062725418,	'model',	5,	'操作url：/onethink/wwwroot/admin.php?s=/Model/update.html',	1,	1412768577),
(6,	11,	1,	-1062725418,	'category',	39,	'操作url：/onethink/wwwroot/admin.php?s=/Category/add.html',	1,	1412768697),
(7,	7,	1,	-1062725418,	'model',	6,	'操作url：/onethink/wwwroot/admin.php?s=/Model/update.html',	1,	1412769184),
(8,	11,	1,	-1062725418,	'category',	39,	'操作url：/onethink/wwwroot/admin.php?s=/Category/edit.html',	1,	1412769997),
(9,	11,	1,	-1062725418,	'category',	39,	'操作url：/onethink/wwwroot/admin.php?s=/Category/edit.html',	1,	1412770024),
(10,	11,	1,	-1062725418,	'category',	40,	'操作url：/onethink/wwwroot/admin.php?s=/Category/add.html',	1,	1412770237),
(11,	11,	1,	-1062725418,	'category',	40,	'操作url：/onethink/wwwroot/admin.php?s=/Category/edit.html',	1,	1412770255),
(12,	11,	1,	-1062725418,	'category',	40,	'操作url：/onethink/wwwroot/admin.php?s=/Category/edit.html',	1,	1412770298),
(13,	11,	1,	-1062725418,	'category',	39,	'操作url：/onethink/wwwroot/admin.php?s=/Category/edit.html',	1,	1412770538),
(14,	11,	1,	-1062725418,	'category',	39,	'操作url：/onethink/wwwroot/admin.php?s=/Category/edit.html',	1,	1412770562),
(15,	11,	1,	-1062725418,	'category',	40,	'操作url：/onethink/wwwroot/admin.php?s=/Category/edit.html',	1,	1412770581),
(16,	7,	1,	-1062725418,	'model',	7,	'操作url：/onethink/wwwroot/admin.php?s=/Model/update.html',	1,	1412771237),
(17,	7,	1,	-1062725418,	'model',	8,	'操作url：/onethink/wwwroot/admin.php?s=/Model/update.html',	1,	1412771293),
(18,	8,	1,	-1062725418,	'attribute',	33,	'操作url：/onethink/wwwroot/admin.php?s=/Attribute/update.html',	1,	1412771342),
(19,	7,	1,	-1062725418,	'model',	8,	'操作url：/onethink/wwwroot/admin.php?s=/Model/update.html',	1,	1412771409),
(20,	7,	1,	-1062725418,	'model',	8,	'操作url：/onethink/wwwroot/admin.php?s=/Model/update.html',	1,	1412771465),
(21,	7,	1,	-1062725418,	'model',	8,	'操作url：/onethink/wwwroot/admin.php?s=/Model/update.html',	1,	1412771547),
(22,	7,	1,	-1062725418,	'model',	8,	'操作url：/onethink/wwwroot/admin.php?s=/Model/update.html',	1,	1412771616),
(23,	11,	1,	-1062725418,	'category',	39,	'操作url：/onethink/wwwroot/admin.php?s=/Category/edit.html',	1,	1412771661),
(24,	7,	1,	-1062725418,	'model',	8,	'操作url：/onethink/wwwroot/admin.php?s=/Model/update.html',	1,	1412771791),
(25,	7,	1,	-1062725418,	'model',	8,	'操作url：/onethink/wwwroot/admin.php?s=/Model/update.html',	1,	1412771927),
(26,	11,	1,	-1062725418,	'category',	39,	'操作url：/onethink/wwwroot/admin.php?s=/Category/edit.html',	1,	1412771983),
(27,	7,	1,	-1062725418,	'model',	8,	'操作url：/onethink/wwwroot/admin.php?s=/Model/update.html',	1,	1412772015),
(28,	7,	1,	-1062725418,	'model',	8,	'操作url：/onethink/wwwroot/admin.php?s=/Model/update.html',	1,	1412772041),
(29,	11,	1,	-1062725418,	'category',	39,	'操作url：/onethink/wwwroot/admin.php?s=/Category/edit.html',	1,	1412772195),
(30,	11,	1,	-1062725418,	'category',	40,	'操作url：/onethink/wwwroot/admin.php?s=/Category/edit.html',	1,	1412772206),
(31,	11,	1,	-1062725418,	'category',	40,	'操作url：/onethink/wwwroot/admin.php?s=/Category/edit.html',	1,	1412772240),
(32,	11,	1,	-1062725418,	'category',	40,	'操作url：/onethink/wwwroot/admin.php?s=/Category/edit.html',	1,	1412772271),
(33,	11,	1,	-1062725418,	'category',	40,	'操作url：/onethink/wwwroot/admin.php?s=/Category/edit.html',	1,	1412772384),
(34,	7,	1,	-1062725418,	'model',	8,	'操作url：/onethink/wwwroot/admin.php?s=/Model/update.html',	1,	1412772657),
(35,	1,	1,	-1062725418,	'member',	1,	'admin在2014-10-09 17:44登录了后台',	1,	1412847851),
(36,	10,	1,	-1062725418,	'Menu',	123,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/add.html',	1,	1412859157),
(37,	10,	1,	-1062725418,	'Menu',	123,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/edit.html',	1,	1412863368),
(38,	10,	1,	-1062725418,	'Menu',	124,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/add.html',	1,	1412863999),
(39,	10,	1,	-1062725418,	'Menu',	125,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/add.html',	1,	1412864898),
(40,	10,	1,	-1062725418,	'Menu',	125,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/edit.html',	1,	1412864942),
(41,	10,	1,	-1062725418,	'Menu',	125,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/edit.html',	1,	1412865034),
(42,	10,	1,	-1062725418,	'Menu',	126,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/add.html',	1,	1412865724),
(43,	10,	1,	-1062725418,	'Menu',	124,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/edit.html',	1,	1412865745),
(44,	10,	1,	-1062725418,	'Menu',	124,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/edit.html',	1,	1412865781),
(45,	1,	1,	-1062725418,	'member',	1,	'admin在2014-10-09 22:44登录了后台',	1,	1412865863),
(46,	10,	1,	-1062725418,	'Menu',	127,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/add.html',	1,	1412903085),
(47,	11,	1,	-1062725418,	'category',	40,	'操作url：/onethink/wwwroot/admin.php?s=/Category/remove/id/40.html',	1,	1412903325),
(48,	11,	1,	-1062725418,	'category',	39,	'操作url：/onethink/wwwroot/admin.php?s=/Category/remove/id/39.html',	1,	1412903328),
(49,	11,	1,	-1062725418,	'category',	1,	'操作url：/onethink/wwwroot/admin.php?s=/Category/edit.html',	1,	1412903339),
(50,	9,	1,	-1062725418,	'channel',	0,	'操作url：/onethink/wwwroot/admin.php?s=/Channel/del/id/4.html',	1,	1412903388),
(51,	9,	1,	-1062725418,	'channel',	2,	'操作url：/onethink/wwwroot/admin.php?s=/Channel/edit.html',	1,	1412903399),
(52,	9,	1,	-1062725418,	'channel',	0,	'操作url：/onethink/wwwroot/admin.php?s=/Channel/del/id/3.html',	1,	1412903406),
(53,	9,	1,	-1062725418,	'channel',	5,	'操作url：/onethink/wwwroot/admin.php?s=/Channel/edit.html',	1,	1412903506),
(54,	9,	1,	-1062725418,	'channel',	5,	'操作url：/onethink/wwwroot/admin.php?s=/Channel/edit.html',	1,	1412903528),
(55,	9,	1,	-1062725418,	'channel',	5,	'操作url：/onethink/wwwroot/admin.php?s=/Channel/edit.html',	1,	1412903573),
(56,	9,	1,	-1062725418,	'channel',	5,	'操作url：/onethink/wwwroot/admin.php?s=/Channel/edit.html',	1,	1412903602),
(57,	9,	1,	-1062725418,	'channel',	5,	'操作url：/onethink/wwwroot/admin.php?s=/Channel/edit.html',	1,	1412903619),
(58,	9,	1,	-1062725418,	'channel',	5,	'操作url：/onethink/wwwroot/admin.php?s=/Channel/edit.html',	1,	1412903954),
(59,	9,	1,	-1062725418,	'channel',	5,	'操作url：/onethink/wwwroot/admin.php?s=/Channel/edit.html',	1,	1412904003),
(60,	9,	1,	-1062725418,	'channel',	5,	'操作url：/onethink/wwwroot/admin.php?s=/Channel/edit.html',	1,	1412904073),
(61,	10,	1,	-1062725418,	'Menu',	1,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/edit.html',	1,	1412904211),
(62,	1,	1,	-1062725418,	'member',	1,	'admin在2014-10-10 10:22登录了后台',	1,	1412907733),
(63,	1,	1,	-1062725418,	'member',	1,	'admin在2014-10-13 10:32登录了后台',	1,	1413167559),
(64,	1,	1,	-1062725418,	'member',	1,	'admin在2014-10-13 10:34登录了后台',	1,	1413167680),
(65,	10,	1,	-1062725418,	'Menu',	128,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/add.html',	1,	1413168147),
(66,	10,	1,	-1062725418,	'Menu',	129,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/add.html',	1,	1413168175),
(67,	10,	1,	-1062725418,	'Menu',	130,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/add.html',	1,	1413168254),
(68,	10,	1,	-1062725418,	'Menu',	131,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/add.html',	1,	1413168284),
(69,	10,	1,	-1062725418,	'Menu',	132,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/add.html',	1,	1413168343),
(70,	10,	1,	-1062725418,	'Menu',	133,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/add.html',	1,	1413168388),
(71,	10,	1,	-1062725418,	'Menu',	134,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/add.html',	1,	1413168714),
(72,	10,	1,	-1062725418,	'Menu',	135,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/add.html',	1,	1413168776),
(73,	10,	1,	-1062725418,	'Menu',	136,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/add.html',	1,	1413168827),
(74,	10,	1,	-1062725418,	'Menu',	137,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/add.html',	1,	1413168866),
(75,	10,	1,	-1062725418,	'Menu',	138,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/add.html',	1,	1413168917),
(76,	10,	1,	-1062725418,	'Menu',	139,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/add.html',	1,	1413169117),
(77,	10,	1,	-1062725418,	'Menu',	125,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/edit.html',	1,	1413169442),
(78,	10,	1,	-1062725418,	'Menu',	125,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/edit.html',	1,	1413169456),
(79,	10,	1,	-1062725418,	'Menu',	125,	'操作url：/onethink/wwwroot/admin.php?s=/Menu/edit.html',	1,	1413169516),
(80,	1,	1,	2071961887,	'member',	1,	'admin在2014-11-02 22:11登录了后台',	1,	1414937483),
(81,	9,	1,	2071961887,	'channel',	5,	'操作url：/onethink/index.php?s=/admin/channel/edit.html',	1,	1414938010),
(82,	9,	1,	2071961887,	'channel',	5,	'操作url：/onethink/index.php?s=/admin/channel/edit.html',	1,	1414938088),
(83,	9,	1,	2071961887,	'channel',	5,	'操作url：/onethink/index.php?s=/admin/channel/edit.html',	1,	1414938299),
(84,	9,	1,	2071961887,	'channel',	5,	'操作url：/onethink/index.php?s=/admin/channel/edit.html',	1,	1414938311);

DROP TABLE IF EXISTS `hm_addons`;
CREATE TABLE `hm_addons` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
INSERT INTO `hm_addons` (`id`, `name`, `title`, `description`, `status`, `config`, `author`, `version`, `create_time`, `has_adminlist`) VALUES
...
DROP TABLE IF EXISTS `hm_attribute`;
CREATE TABLE `hm_attribute` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `hm_attribute` (`id`, `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES
...
DROP TABLE IF EXISTS `hm_auth_extend`;
CREATE TABLE `hm_auth_extend` (
...
INSERT INTO `hm_auth_extend` (`group_id`, `extend_id`, `type`) VALUES
(1,	1,	1),
(1,	1,	2),
(1,	2,	1),
(1,	2,	2),
...
INSERT INTO `hm_auth_group` (`id`, `module`, `type`, `title`, `description`, `status`, `rules`) VALUES
...
INSERT INTO `hm_auth_rule` (`id`, `module`, `type`, `name`, `title`, `status`, `condition`) VALUES
...
(218,	'admin',	2,	'Admin/Gis/index',	'GIS系统',	1,	''),
(219,	'admin',	1,	'Admin/Gis/dataUp',	'数据上传',	1,	'');
...
INSERT INTO `hm_category` (`id`, `name`, `title`, `pid`, `sort`, `list_row`, `meta_title`, `keywords`, `description`, `template_index`, `template_lists`, `template_detail`, `template_edit`, `model`, `model_sub`, `type`, `link_id`, `allow_publish`, `display`, `reply`, `check`, `reply_model`, `extend`, `create_time`, `update_time`, `status`, `icon`, `groups`) VALUES
(1,	'blog',	'新闻',	0,	0,	10,	'',	'',	'',	'',	'',	'',	'',	'2,3',	'2',	'2,1',	0,	0,	1,	0,	0,	'1',	'',	1379474947,	1412903339,	1,	0,	''),
...
INSERT INTO `hm_channel` (`id`, `pid`, `title`, `url`, `sort`, `create_time`, `update_time`, `status`, `target`) VALUES
(1,	0,	'首页',	'Index/index',	1,	1379475111,	1379923177,	1,	0),
(2,	0,	'新闻',	'Article/index?category=blog',	3,	1379475131,	1412903399,	1,	0),
(5,	0,	'GIS系统',	'Admin/Gis/index',	2,	1412903442,	1414938311,	1,	0);
...
INSERT INTO `hm_config` (`id`, `name`, `type`, `title`, `group`, `extra`, `remark`, `create_time`, `update_time`, `status`, `value`, `sort`) VALUES
(1,	'WEB_SITE_TITLE',	1,	'网站标题',	1,	'',	'网站标题前台显示标题',	1378898976,	1379235274,	1,	'农产品产地环境安全管理系统',	0),
(2,	'WEB_SITE_DESCRIPTION',	2,	'网站描述',	1,	'',	'网站搜索引擎描述',	1378898976,	1379235841,	1,	'农产品产地安全管理系统',	1),
(3,	'WEB_SITE_KEYWORD',	2,	'网站关键字',	1,	'',	'网站搜索引擎关键字',	1378898976,	1381390100,	1,	'土壤重金属,产地环境',	8),
...
INSERT INTO `hm_document` (`id`, `uid`, `name`, `title`, `category_id`, `group_id`, `description`, `root`, `pid`, `model_id`, `type`, `position`, `link_id`, `cover_id`, `display`, `deadline`, `attach`, `view`, `comment`, `extend`, `level`, `create_time`, `update_time`, `status`) VALUES
(1,	1,	'',	'系统发布',	2,	0,	'系统发布',	0,	0,	2,	2,	0,	0,	0,	1,	0,	0,	24,	0,	0,	0,	1406001360,	1413169388,	1);

DROP TABLE IF EXISTS `hm_document_article`;
CREATE TABLE `hm_document_article` (
...
INSERT INTO `hm_document_article` (`id`, `parse`, `content`, `template`, `bookmark`) VALUES
(1,	0,	'<h1>\r\n	系统发布ing...\r\n</h1>',	'',	0);

DROP TABLE IF EXISTS `hm_document_download`;
CREATE TABLE `hm_document_download` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '文档ID',
  `parse` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '内容解析类型',
...
DROP TABLE IF EXISTS `hm_hooks`;
CREATE TABLE `hm_hooks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
INSERT INTO `hm_hooks` (`id`, `name`, `description`, `type`, `update_time`, `addons`, `status`) VALUES
...
INSERT INTO `hm_member` (`uid`, `nickname`, `sex`, `birthday`, `qq`, `score`, `login`, `reg_ip`, `reg_time`, `last_login_ip`, `last_login_time`, `status`) VALUES
(1,	'admin',	0,	'0000-00-00',	'',	30,	9,	0,	1412766492,	2071961887,	1414937483,	1);
...
INSERT INTO `hm_menu` (`id`, `title`, `pid`, `sort`, `url`, `hide`, `tip`, `group`, `is_dev`, `status`) VALUES
(1,	'首页',	0,	1,	'Index/index',	1,	'',	'',	0,	1),
(2,	'内容',	0,	3,	'Article/index',	0,	'',	'',	0,	1),
...
(123,	'GIS系统',	0,	2,	'Gis/index',	0,	'',	'',	0,	1),
(124,	'数据上传',	123,	2,	'Gis/dataUp',	0,	'',	'采样点管理',	0,	1),
(125,	'通知',	2,	0,	'article/index',	1,	'',	'分组',	0,	1),
(126,	'数据导出',	123,	3,	'Gis/dataDown',	0,	'说明无',	'采样点管理',	0,	1),
(127,	'展示',	123,	1,	'Gis/index',	0,	'',	'',	0,	1),
(128,	'数据上传',	123,	4,	'Gis/dataUp',	0,	'',	'污染源管理',	0,	1),
(129,	'数据导出',	123,	5,	'Gis/dataDown',	0,	'',	'污染源管理',	0,	1),
(130,	'克里金插值',	123,	6,	'Gis/Kring',	0,	'',	'统计分析',	0,	1),
(131,	'反距离插值',	123,	7,	'Gis/IDW',	0,	'',	'统计分析',	0,	1),
(132,	'自然领域法插值',	123,	8,	'Gis/nature',	0,	'',	'统计分析',	0,	1),
(133,	'R语言拓展插值',	123,	9,	'Gis/R',	0,	'',	'统计分析',	0,	1),
(134,	'污染评价',	123,	10,	'Gis/pollutionEval',	0,	'',	'产地安全',	0,	1),
(135,	'污染溯源',	123,	11,	'Gis/pollutionSource',	0,	'',	'产地安全',	0,	1),
(136,	'污染预测',	123,	12,	'Gis/pollutionForecast',	0,	'',	'产地安全',	0,	1),
(137,	'污染治理',	123,	13,	'Gis/pollutionDeal',	0,	'',	'产地安全',	0,	1),
(138,	'种植指导',	123,	14,	'Gis/plant',	0,	'',	'产地安全',	0,	1),
(139,	'划分禁产区',	123,	0,	'Gis/drawArea',	0,	'',	'产地安全',	0,	1);
...
INSERT INTO `hm_model` (`id`, `name`, `title`, `extend`, `relation`, `need_pk`, `field_sort`, `field_group`, `attribute_list`, `attribute_alias`, `template_list`, `template_add`, `template_edit`, `list_grid`, `list_row`, `search_key`, `search_list`, `create_time`, `update_time`, `status`, `engine_type`) VALUES
...
DROP TABLE IF EXISTS `hm_ucenter_admin`;
CREATE TABLE `hm_ucenter_admin` (
...
DROP TABLE IF EXISTS `hm_ucenter_app`;
CREATE TABLE `hm_ucenter_app` (
...
DROP TABLE IF EXISTS `hm_userdata`;
CREATE TABLE `hm_userdata` (
  `uid` int(10) unsigned NOT NULL COMMENT '用户id',
