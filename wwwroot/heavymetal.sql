...
(5,	0,	'GIS系统',	'http://192.168.24.210:88/onethink/wwwroot/admin.php?s=/Gis/index.html',	2,	1412903442,	1412904073,	1,	0);
...
(1,	1,	'',	'系统发布',	2,	0,	'系统发布',	0,	0,	2,	2,	0,	0,	0,	1,	0,	0,	13,	0,	0,	0,	1406001360,	1413169388,	1);
...
(1,	'admin',	0,	'0000-00-00',	'',	20,	8,	0,	1412766492,	3232241878,	1413167680,	1);
